  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="<?=base_url('main/utama');?>">Manage GPS</a></li>
        <li><a href="<?=base_url('main/manage_user');?>">Manage User</a></li>
      </ul><br>
    </div>
<?php }else{?>
<nav class="navbar navbar-inverse">
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="<?= base_url('main/change_pwd');?>">Change Password</a></li>
      </ul><br>
    </div>
<?php }
?>