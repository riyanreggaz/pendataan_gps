...
<body>
    ...
    <div class="col-sm-9">
      <h4><small>EDIT PROFILE</small></h4>
      <hr>
...
<div class="col-md-6">
    ...
    <input type="text" placeholder="Masukkan Username Anda" name="username" value="<?=$username;?>">

   <label ><b>Nama</b></label>
    <input type="text" placeholder="Masukkan Nama Anda" name="nama" value="<?=$nama;?>">
